...
public class MyAccountsPage extends Utility {
    ...
    public void clickOnMyAccountLink() {
        Reporter.log("clicking on my accountlink");
        CustomListeners.test.log(Status.PASS, "clicking on my accountlink");
    ...
    public void enterConfirmPassword(String conPassword) {
        Reporter.log("Enter confirmPassword " + conPassword +"to confirmPassword" +confirmPassword.toString());
        CustomListeners.test.log(Status.PASS, "Enter confirmPassword " + conPassword);
        sendTextToElement(confirmPassword, conPassword);
    }

    public void clickOnYesRadioButton() {
        Reporter.log("clicking on radiobutton");
        CustomListeners.test.log(Status.PASS, "clicking on radiobutton");
        clickOnElement(yesRadioButton);
    }

    public void clickOnPrivacyPolicyCheckBox() {
        Reporter.log("Clicking on privacy policy checkbox");
        CustomListeners.test.log(Status.PASS, "Clicking on privacy policy checkbox");
    ...
    public void clickOnContinueTab() {
        Reporter.log("Clicking on continue tab");
        CustomListeners.test.log(Status.PASS, "Clicking on continue tab");
        clickOnElement(continueTab);
    }

    public void clickOnMyAccountTab() {
        Reporter.log("Clicking on my account tab");
        CustomListeners.test.log(Status.PASS, "Clicking on my account tab");
    ...
    public void clickOnContinue() {
        ...
        CustomListeners.test.log(Status.PASS, "Clicking on continue");
    ...
    public void clickOnMyAccount() {
        Reporter.log("Clicking on my Account");
        CustomListeners.test.log(Status.PASS, "Clicking on my Account");
    ...
    public void clickOnContinueLink() {
        ...
        CustomListeners.test.log(Status.PASS, "Clicking on continue link");
